...
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion, nss, aseguradora) VALUES(1, '71295830A', 'Alvaro Trigo Lopez', 947883322, 'C/Vitoria 34 esc2 2�C', 98873435, 'Don mendo aseguradora');
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion, nss) VALUES(2, '71295832A', 'Alvaro Lopez Lopez', 111883322, 'C/Notengo 34 esc2 2�C', 22273435);
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion) VALUES(3, '71295833A', 'Alvaro Perez Lopez', 222883322, 'C/Avenida 34 esc2 2�C');
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion, nss) VALUES(4, '71295834A', 'Alvaro Juan Lopez', 333883322, 'C/Saiz del pepe 34 esc2 2�C', 44473435);
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion, nss, aseguradora) VALUES(5, '71295835A', 'Alvaro Diez Lopez', 444883322, 'C/Camarero 34 esc2 2�C', 55573435,'Alonso aseguradoras');
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion, nss) VALUES(6, '71295836A', 'Alvaro Saez Lopez', 555883322, 'C/Ordenador 34 esc2 2�C', 66673435);
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion) VALUES(7, '71295837A', 'Alvaro Orozco Lopez', 666883322, 'C/Raton 34 esc2 2�C');
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion, nss, aseguradora) VALUES(8, '71295838A', 'Alvaro Camara Lopez', 777883322, 'C/Alfombrilla 34 esc2 2�C', 77773435,'Aseguradora PLO');
INSERT INTO PACIENTE(idPaciente, dni, nombre, telefono, direccion, nss) VALUES(9, '71295839A', 'Alvaro Sobrino Lopez', 888883322, 'C/Apple 34 esc2 2�C', 99973435);
...
INSERT INTO HOSPITAL(idHospital, nombre, direccion, codigoPostal, telefono) VALUES(4, 'Hospital del buen steve', 'C/Alcal� 45', 09021, 777866322);
...
INSERT INTO SANITARIO(idPersonal, idHospital, idGuardia, dni, nombre, calle, telefono, tipo) VALUES(2,1,1,'72295566Z', 'Miguel Lopez', 'C/ccccantabia n�2', 666888444, 'M');
INSERT INTO SANITARIO(idPersonal, idHospital, idGuardia, dni, nombre, calle, telefono, tipo) VALUES(3,2,1,'73295566Z', 'Elena Maria', 'C/aaaDel cid 25 n�1', 555888666, 'M');
INSERT INTO SANITARIO(idPersonal, idHospital, idGuardia, dni, nombre, calle, telefono, tipo) VALUES(4,2,1,'74295566Z', 'Maria del Pilar', 'C/sdddantander 201 4�b', 888888555, 'M');
...
INSERT INTO ADMINISTRACION(idPersonal, idHospital, idAsuntosPropios, dni, nombre, calle, telefono) VALUES(2,1,1,'72295566Z', 'Steve Jobs', 'C/cantabia n�2', 666888999);
INSERT INTO ADMINISTRACION(idPersonal, idHospital, idAsuntosPropios, dni, nombre, calle, telefono) VALUES(3,2,1,'73295566Z', 'Bill Gates', 'C/Del cid 25 n�1', 555888999);
INSERT INTO ADMINISTRACION(idPersonal, idHospital, idAsuntosPropios, dni, nombre, calle, telefono) VALUES(4,2,1,'74295566Z', 'Wozniak Jobs', 'C/santander 201 4�b', 888888999);
